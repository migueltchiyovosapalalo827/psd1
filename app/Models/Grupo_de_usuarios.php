 ...
 * @property TarefasDosGrupo[] $tarefasDosGrupos
 * @property Usuario[] $usuarios
 * @author Fabrício Gonga
 */
class Grupo_de_usuarios extends Model
{
    use HasFactory;
    /**
     * @var array
     ...
     */
    public function tarefasDosGrupos(): \Illuminate\Database\Eloquent\Relations\HasMany
    {
        return $this->hasMany(Tarefas_dos_grupos::class, 'grupo_de_usuarios_id');
    }
    ...
    {
        return $this->hasMany(Usuarios::class, 'grupo_de_usuarios_id');
    }
}
